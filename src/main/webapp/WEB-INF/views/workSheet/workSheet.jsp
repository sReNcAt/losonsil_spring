        ...
        <div class="container">
            <div class="row" id="mainNotice">
            	...
            	<div class="col">
            		<div class="float-right">
	            		...
	            		<button class="btn btn-sm btn-primary btn-secondary btn-work-content" data-tear="1">1티어</button>
	            		 -->
	            		<button class="btn btn-sm btn-primary btn-secondary btn-work-content" data-tear="2">2티어</button>
	            		<button class="btn btn-sm btn-primary btn-work-content" data-tear="3">3티어</button>
            		</div>
            	</div>  
            </div>
            <div class="row mb-1">
			...
			<div class="row" id="workContent" style="text-align:center;">
				<div class="col" style="text-align:center;">
					<!--
					<table class="table table-bordered work-table" id="tearOneTable" style="width:100%;">
						<colgroup>
							<col><col>
							<col><col>
						</colgroup> 
					...
					-->
					<table class="table table-bordered work-table" id="tearTwoTable" style="width:100%;">
						<colgroup>
							<col width="15%">
							<col width="20%">
							<col width="20%">
						...
						<thead>
							<tr>
								...
								<th class="">카이슈테르</th>
								<th class="">태만의바다</th>
								<th class="">고요한<br>카르코사</th>
								<th class="">아르카디아의<br>성역</th>
							</tr>
						</thead>
						<tbody>
						</tbody>
					</table> 
					<table class="table table-bordered work-table" id="tearThreeTable" style="width:100%;display:none;">
						<colgroup>
							<col><col>
							<col>
						</colgroup>
